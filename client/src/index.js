...
import {getHeaderCount} from './store/actions/header/action-creators';
...
store.dispatch(getPeerList("mychannel"));
store.dispatch(getBlockList("mychannel",0));
store.dispatch(getTransactionList("mychannel"));
...
store.dispatch(getHeaderCount("mychannel"));
