...
export class DashboardView extends Component {
  ...
  componentWillMount() {
    if (
      this.props.blockList == undefined ||
      this.props.dashStats == undefined ||
      this.props.peerStatus == undefined ||
      this.props.transactionByOrg == undefined
    ) {
          ...
          <Row>
            <Col sm="6">
              <Card className="dash-section">
                <PeersHealth peerStatus={this.props.peerStatus} />
              </Card>
              <Card className="dash-section">
                <TimelineStream
